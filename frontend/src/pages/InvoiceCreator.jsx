            ...
            const invoicePayload = {
                ...
                payments: Object.entries(payment)
                    ...
                    .map(([mode, amount]) => {
                        ...
                        return {
                            method: methodMap[mode] || (mode.charAt(0).toUpperCase() + mode.slice(1)),
            ...
            <div className="p-4 md:p-8 min-h-screen bg-gray-50/50 dark:bg-black transition-colors duration-500">
                ...
                <div ref={formRef} className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        {/* Invoice Settings */}
                        <div className="bg-white/80 dark:bg-[#09090b]/60 backdrop-blur-xl rounded-[28px] p-8 box-outline shadow-2xl transition-all duration-300">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-5 py-3.5 border border-gray-100 dark:border-white/10 rounded-2xl text-sm font-bold bg-white/50 dark:bg-black/40 text-gray-900 dark:text-white focus:ring-4 focus:ring-rose-500/20 focus:border-rose-500 transition-all appearance-none"
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-5 py-3.5 border border-brand-500/40 dark:border-brand-500/30 rounded-2xl text-sm font-bold bg-white/50 dark:bg-black/40 text-gray-900 dark:text-white focus:ring-4 focus:ring-rose-500/20 focus:border-rose-500 transition-all"
                                        />
                                    </div>
                        ...
                        <div className="bg-white/80 dark:bg-[#09090b]/60 backdrop-blur-xl rounded-[28px] p-6 box-outline shadow-2xl relative z-10 transition-all duration-300">
                            <h3 className="font-black text-xs uppercase tracking-widest text-rose-600 dark:text-rose-400 mb-6 flex items-center gap-3">
                            ...
                            <div className="mb-6 relative group">
                                <input
                                    ...
                                    className="w-full pl-12 pr-6 py-4 border border-rose-100 dark:border-white/5 bg-rose-50/50 dark:bg-black/40 rounded-[22px] text-sm font-medium focus:ring-4 focus:ring-rose-500/10 focus:bg-white dark:focus:bg-black tertiary-input transition-all placeholder-rose-300 dark:placeholder-rose-800"
                                    onChange={(e) => {
                                ...
                                {[
                                    ...
                                    <div key={field.value}>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-3 border border-gray-100 dark:border-white/10 rounded-2xl text-sm font-bold bg-white/50 dark:bg-black/40 text-gray-900 dark:text-white focus:ring-4 focus:ring-rose-500/20 focus:border-rose-500 transition-all placeholder-gray-300 dark:placeholder-gray-700"
                        ...
                        {/* Company Details */}
                        <div className="bg-white/80 dark:bg-[#09090b]/60 backdrop-blur-xl rounded-[28px] p-8 box-outline shadow-2xl transition-all duration-300 overflow-hidden">
                            <button
                    ...
                    <div className="lg:col-span-6 space-y-8 relative z-10">
                        ...
                        <div className="bg-white/80 dark:bg-[#09090b]/60 backdrop-blur-xl rounded-[32px] p-8 box-outline shadow-2xl transition-all duration-300">
                            <h3 className="font-black text-xs uppercase tracking-widest text-rose-600 dark:text-rose-400 mb-6 flex items-center gap-3">
                                <Store className="w-4 h-4" />
                                Add Products
                            </h3>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 items-end mb-8">
                                <div className="flex-1 relative">
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full px-6 py-4 border border-brand-500/80 dark:border-brand-500/70 rounded-[22px] focus:ring-4 focus:ring-rose-500/10 bg-white/50 dark:bg-black/20 text-gray-900 dark:text-white placeholder-gray-400 transition-all font-bold"
                                        />
                                        <Search className="w-5 h-5 text-rose-400 absolute right-6 top-4 group-focus-within:scale-110 transition-transform" />

                                        {showProductSearch && filteredProducts.length > 0 && (
                                            <div className="absolute z-50 w-full mt-3 bg-white/95 dark:bg-[#0A0A0A]/95 backdrop-blur-2xl border border-brand-500/80 dark:border-brand-500/70 rounded-[28px] shadow-[0_32px_96px_-16px_rgba(0,0,0,0.5)] max-h-[400px] overflow-y-auto overflow-x-hidden p-2 no-scrollbar">
                                ...
                                <div className="w-32">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-4 border border-brand-500/80 dark:border-brand-500/70 rounded-[22px] text-center text-gray-900 dark:text-white font-black text-xl bg-white/50 dark:bg-black/20 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500"
                                        min="1"
                                    />
                                </div>
                                <button
                            ...
                            <div className="pt-6 border-t-[2.5px] border-black dark:border-white/90">
                                <button
                                    onClick={() => addItem(null, true)}
                                    className="text-[10px] font-black uppercase tracking-[0.2em] text-rose-600 dark:text-rose-400 hover:rose-800 flex items-center gap-3 px-6 py-4 border border-dashed border-brand-500/30 dark:border-brand-500/20 rounded-[22px] hover:bg-rose-50 dark:hover:bg-rose-500/5 transition-all w-full justify-center group"
                                >
                    ...
                    <div className="lg:col-span-3 space-y-8 sticky top-8 self-start h-fit">
                        {/* Summary Card */}
                        <div className="bg-slate-900 dark:bg-black rounded-[32px] p-8 box-outline shadow-2xl transition-all duration-300">
                            <div className="mb-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="h-px bg-brand-500/30 my-6"></div>
                            ...
                            <div className="space-y-6 mb-10">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={mode.value} className="bg-white/5 rounded-2xl p-4 border border-brand-500/20 focus-within:border-rose-500 transition-all">
